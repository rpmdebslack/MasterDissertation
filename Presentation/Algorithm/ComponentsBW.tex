...
\begin{tikzpicture}
    ...
    \tikzstyle{lcomp}=[draw, text width=5em, 
        text centered, minimum height=2.5em,text centered]

    \tikzstyle{ann} = [above, text width=5em]

    \tikzstyle{program} = [lcomp, text width=6em, 
        minimum height=6em, minimum width=10em, rounded corners,text centered]

    \tikzstyle{global} = [lcomp, text width=6em, minimum height=6em, minimum width=8em, rounded corners,text centered]

    \tikzstyle{reconf} = [lcomp, text width=8em, 
        minimum height=4em, minimum width=8em, rounded corners,text centered]

    \tikzstyle{lf} = [lcomp, text width=8em, 
        minimum height=4em, minimum width=8em, rounded corners,text centered]

    \tikzstyle{local} = [draw, circle, text width=3em,
        minimum height=3em, minimum width=3em, text centered]
    ...
    \begin{pgfonlayer}{background}
        ...
        \path[fill=gray!01,rounded corners, draw=black!50, dashed]
            (a) rectangle (b);
